...
@section('content')
    <div class="container">
      ...
      {!! Form::open(['action' => ['privateRepliesController@store',$group_id,$post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    ...
    {{-- <form id="add-comment-form" action="privateRepliesController@" method="POST">
      {{ csrf_field() }}
     <div class="form-group">
